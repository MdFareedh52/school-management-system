...
<head>
  <title>Attendance Report</title>
   <link rel="shortcut icon" href="img/approve.png" style="height:20px;">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary col-md-6" style="width:1500px;position: relative;height: 80px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <a class="navbar-brand" href="#home" style="font-size:30px; margin-left: 300px; font-weight: 900; color: white;text-shadow: 2px 2px black;">Report</a>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="attendancereport.php">
          ...
          <span style="margin-left: 10px;">Attendence Report<img src="img/icons/right-arrow.png" style="height:25px;margin-left: 0px;"></span>
        </a>
      </li>
      <li>
...
<div class="container bg-light" style="width: 1100px;margin-right: 130px;">
  <div class="card-body" style="background-color:#9C27B0;margin-bottom: 20px;">
    <div class="row-right">
    <h3 style="font-weight: 900;color: white;text-shadow: 2px 2px black;">Attendance Report</h3>
    <h5 style="font-weight: 900;margin-left: 20px;"><svg style="height: 30px;width: 30px;display: inline;margin-right: 7px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="clipboard-list" class="svg-inline--fa fa-clipboard-list fa-w-12" role="img" viewBox="0 0 384 512"><path fill="currentColor" d="M336 64h-80c0-35.3-28.7-64-64-64s-64 28.7-64 64H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM96 424c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm96-192c13.3 0 24 10.7 24 24s-10.7 24-24 24-24-10.7-24-24 10.7-24 24-24zm128 368c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16z"></path></svg> Enter Student Attendance Report</h5>
  </div>
  </div>
<section style="margin-left: 20px;margin-top: 10px;">
       <select class="form-select" aria-label="Default select example" id="select-id" style="background-color: #d1e0e0;width: 370px;">
  <option selected value="attendencereport.php">Select Class</option>
  <option value="class1/class1.php">Class-1</option>
  <option value="class2/class2.php">Class-2</option>
  <option value="class3/class3.php">Class-3</option>
   <option value="class4/class4.php">Class-4</option>
    <option value="class5/class5.php">Class-5</option>
</select>
<button onclick="siteRedirect()" class="btn btn-success" style="margin-top:10px;margin-bottom: 20px;">Get Report!</button>
