  ...
  <nav>
    <a href="home.php" aria-label="Teacher" class="logo" style="margin-right: 30px;">
      <svg width="10" height="10">
       <img src="slack.png" href="#logo" style="margin-left: 10px;"><h3 style="margin-left: 30px;">Teacher</h3>
      </svg>
    </a>
...
<h1 style="color:rgb(129, 99, 71)">Teacher Data Here.</h1>
<br>
<form action="insert.php" method="post" class="row g-3" style="padding-bottom:20px;">

 <div class="col-md-6">
    <label for="inputEmail4" id="mass" class="form-label" style="color:orange">Name</label>
  ...
  <div class="col-12">
  	<br>
    <button type="submit" class="btn btn-primary" name="button">Insert</button>
  </div>
