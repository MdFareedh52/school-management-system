...
<form method="POST" name="search" action="classwise1.php">
        <div id="demo-grid">
    ...
    window.print();
                ...
                if (! empty($result)) {
                    foreach ($result as $key => $value) {
                        ?>
                <tr>
                         <td><div class="col-md-6" id="user_data_0"><img src="img/profile.png"style="height: 30px;width: 30px;"></div></td>
                        ...
                        <td><div class="col-md-6" id="user_data_3"><?php echo $result[$key]['Class']; ?> </div></td>
                         <td><div class="col-md-6" id="user_data_4"><?php echo $result[$key]['Date_of_Birth']; ?> </div></td>
                          <td><div class="col-md-6" id="user_data_5"><?php echo $result[$key]['Qualification']; ?> </div></td>
                          <td><div class="col-md-6" id="user_data_5"><?php echo $result[$key]['Gender']; ?> </div></td>
                          <td><div class="col-md-6" id="user_data_5"><?php echo $result[$key]['Email']; ?> </div></td>
                          <td><div class="col-md-6" id="user_data_5"><?php echo $result[$key]['Address']; ?> </div></td>
                          <td><div class="col-md-6" id="user_data_5"><?php echo $result[$key]['Contact']; ?> </div></td>
...
<a href="teacherlist.php"><button class="btn btn-success" style="margin-left: 30px;"><img src="img/previous.png" style="height: 25px;width: 25px;">Back</button></a>
