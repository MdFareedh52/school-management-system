...
<head>
  <title>Event</title>
  <link rel="shortcut icon" href="img/calendar.png" style="height:20px;">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary col-md-6" style="width:1500px;position: relative;height: 80px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <a class="navbar-brand" href="#home" style="font-size:30px; margin-left: 300px; font-weight: 900; color: white;text-shadow: 2px 2px black;">Events</a>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="event.php">
          ...
          <span style="margin-left: 10px;">Events<img src="img/icons/right-arrow.png" style="height:25px;margin-left: 50px;"></span>
        </a>
      </li>
      <li>
...
if (isset($_POST['formad'])) {
  ...
  $Place = $_POST['place'];
   ...
   $select="INSERT INTO event (id,EventTitle,Discription,EventDate,Place) VALUES (0,'$EventTitle','$Discription','$Eventdate','$Place')";
   if (mysqli_query($con,$select))
 {
  echo '<div class="alert alert-success">Data Inserted Successfully</div>';
    ...
    echo 'alert("Registration Failed:  Enter the Given Data")';
    echo '</script>';
}
mysqli_close($con);
}
...
<div class="container bg-light" style="width: 1100px;margin-right: 130px;">
  <div class="card-body" style="background-color:#9C27B0;margin-bottom: 20px;">
    <div class="row-right">
    <h3 style="font-weight: 900;color: white;text-shadow: 2px 2px black;">Event</h3>
    <h5 style="font-weight: 900;margin-left: 20px;"><svg style="height: 30px;width: 30px;display: inline;margin-right: 7px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="clipboard-list" class="svg-inline--fa fa-clipboard-list fa-w-12" role="img" viewBox="0 0 384 512"><path fill="currentColor" d="M336 64h-80c0-35.3-28.7-64-64-64s-64 28.7-64 64H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM96 424c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm96-192c13.3 0 24 10.7 24 24s-10.7 24-24 24-24-10.7-24-24 10.7-24 24-24zm128 368c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16z"></path></svg>Complete the Event </h5>
  </div>
  </div>
  <form class="row g-3" method="post" action="event.php" name="Form">
  <div class="col-md-5" class="border border-5">
...
<div class="col-md-6">
  ...
  <input type="text" class="form-control" id="discription" rows="3" name="discription">
</div>
</section>
 <div class="col-4">
    <label for="inputAddress1" class="form-label">Event Date</label>
    <input type="date" class="form-control" id="inputBirth" name="date">
  </div>
  <div class="col-md-3">
    <label for="place" class="form-label" style="font-weight: bold;font-size: ;">Place</label>
...
<br>
  <section>
 <button type="submit" class="btn btn-success" name="formad" id="insert" style="margin-bottom:40px">Insert Event</button>
  <!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="margin-bottom:40px">
  Show Events
</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="staticBackdropLabel" style="margin-left: 300px; color:white;">Event Show</h5>
...
<header class="page-header">
  <nav>
    <a href="home.php" aria-label="Teacher" class="logo" style="margin-right: 30px;">
      <svg width="10" height="10">
       <img src="test.png" href="#logo" style="margin-left: 10px;"><h3 style="margin-left: 30px;">Teacher</h3>
      </svg>
    </a>
    <button class="toggle-mob-menu" aria-expanded="false" aria-label="open menu">
      <svg width="20" height="20" aria-hidden="true">
...
<section class="page-content">
  ...
  <div class="container-fluid" style="float: right;">
    ...
    <img src=slack.png alt="" width="35" height="30" class="d-inline-block align-text-top">
      Event
    </a>
  </nav><br>
<h1 style="font-weight: 900; font-size: 46px;">Event Enter <span style="color:#0080ff;">Here!</span></h1>
    <section>
 <?php
...
if (isset($_POST['formad'])) {
  ...
  $Place = $_POST['place'];
   ...
   $select="INSERT INTO event_approval (id,EventTitle,Discription,EventDate,Place) VALUES (0,'$EventTitle','$Discription','$Eventdate','$Place')";
   if (mysqli_query($con,$select))
 {
  echo '<div class="alert alert-success">Data Inserted Successfully</div>';
} 
...
<br>
  <section>
 <button type="submit" class="btn btn-success" name="formad" id="insert">Insert Event</button>
 <a href="eventshow.php" type="submit" class="btn btn-primary">Show Event</a>
  <a href="approvedevent.php" type="submit" class="btn btn-warning">Approved Events</a>
