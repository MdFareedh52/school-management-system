  ...
  <nav>
    <a href="home.php" aria-label="Teacher" class="logo" style="margin-right: 30px;">
      <svg width="10" height="10">
       <img src="img/test.png" href="#logo" style="margin-left: 10px;"><h3 style="margin-left: 30px;">Teacher</h3>
      </svg>
    </a>
...
<section class="page-content">
  <section class="search-and-user">
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="width: 1250px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="home.php" style="margin-top:5px;font-size: 20px;margin-left: 480px;">Dashboard</a>
      </li>
      <li class="nav-item">
  ...
  <h1 style="font-weight:900 ;">Show<span style="font-weight: 900;color: #0099ff"> Events!</span></h1>
<?php  
$user = 'root';
$password = ''; 
$database = 'school1'; 
...
<section class="page-content" style="width: 1300px;">
  <section class="search-and-user">
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="home.php" style="font-size:30px; margin-left: 20px; font-weight: 900;"><img src="img/teamwork.png"> Principal</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
  ...
  <h1>Show<span style="font-weight: 900;color: #0099ff"> Events</span></h1>
<?php  
$user = 'root';
$password = 'mdfareedh'; 
$database = 'school1'; 
