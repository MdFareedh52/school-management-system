...
<head>
  ...
  <link rel="shortcut icon" href="img/employee.png">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary col-md-6" style="width:1500px;position: relative;height: 80px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <a class="navbar-brand" href="#home" style="font-size:30px; margin-left: 300px; font-weight: 900; color: white;text-shadow: 2px 2px black;">Event Approval</a>
      <li class="nav-item" style="margin-left:0px">  
      </li>
      <li>
        <a class="nav-link" href="" style="margin-left:810px;"><img src="img/icons/gmail.png" style="height:30px;width: 30px;"></a>
      </li>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="eventapproval.php">
          ...
          <span style="margin-left: 10px;">Event Approval<img src="img/icons/right-arrow.png" style="height:25px;margin-left: 0px;"></span>
        </a>
      </li>
      <li>
...
if (isset($_POST['formad'])) {
  ...
  $EventApproval = $_POST['eventapproval'];
  $Place = $_POST['place'];

   $select="INSERT INTO event_approval (id,EventTitle,Discription,EventDate,EventApproval,Place) VALUES (0,'$EventTitle','$Discription','$Eventdate','$EventApproval','$Place')";
...
<div class="container bg-light" style="width: 1100px;margin-right: 130px;">
  <div class="card-body" style="background-color:#9C27B0;margin-bottom: 20px;">
    <div class="row-right">
    <h3 style="font-weight: 900;color: white;text-shadow: 2px 2px black;">Student-List</h3>
    <h5 style="font-weight: 900;margin-left: 20px;"><svg style="height: 30px;width: 30px;display: inline;margin-right: 7px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="clipboard-list" class="svg-inline--fa fa-clipboard-list fa-w-12" role="img" viewBox="0 0 384 512"><path fill="currentColor" d="M336 64h-80c0-35.3-28.7-64-64-64s-64 28.7-64 64H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM96 424c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm96-192c13.3 0 24 10.7 24 24s-10.7 24-24 24-24-10.7-24-24 10.7-24 24-24zm128 368c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16z"></path></svg> list is here</h5>
  </div>
  </div>

  <form class="row g-3" method="post" action="eventapproval.php" name="Form">
...
<div class="col-md-6">
 ...
 <div class="col-4">
  ...
  <div class="col-md-3">
    <label for="place" class="form-label" style="font-weight: bold;font-size: ;">Event Approval</label>
     <select class="form-select" id="eventapproval" name="eventapproval">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="staticBackdropLabel" style="font-weight:900"><img src="img/party.png" style="height:30px;width: 30px;">Events</h5>
...
<table class="table table-striped table-hover">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-dark" data-bs-dismiss="modal" style="margin-right:370px">Close</button>
      </div>
    </div>
  </div>
</div>
