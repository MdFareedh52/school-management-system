...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `teacher_register` WHERE CONCAT(`Id`, `Name`, `Class`, `Date_of_Birth`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `teacher_register`";
    $search_result = filterTable($query);
}
...
<span id='ct7' style="color: black; font-size: 23px; font-weight: 900;padding-bottom: 40px;"></span></a>
      ...
      <li class="nav-item1-dropdown">
        ...
        <form action="teacher1.php" method="post" style="margin-top:50px; margin-left: 10px;">
            <img src="img/magnifying-glass.png" style="height:30px;width: 30px;margin-right: 10px;"><input type="text" name="valueToSearch" placeholder="Search.." style="border-color: black;border: 3px solid black;">      
            <input type="submit" name="search" value="Filter" style="background-color:#2BC48A; color: white;height: 30px;">
            <a href="teacher1.php"><button class="btn btn-warning"style="margin-bottom: 10px;margin-left: 1000px;">Show Full</button></a>
                <button class="btn btn-primary hidden-print" onclick="myFunction()" style="margin-bottom: 10px;"><span class="glyphicon glyphicon-print" aria-hidden="true"></span><img src="img/printer.png" style="height:25px;width: 25px;"> Print</button>
        <script>
            function myFunction() {
    window.print();
}
      ...
      <!-- populate table from mysql database -->
                ...
                <tr>
                    <td><img src="img/admin-default.png" style="height:30px;width: 30px;"></td>
   ...
   <a href="teacherlist.php"><button class="btn btn-success" style="margin-left:1300px;"><img src="img/previous.png" style="height:25px;width: 25px; margin-right: 5px;">Back</button></a>
        <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><img src="img/menu.png" style="height: 25px;width: 25px;"> Options</button>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <a href="teacher1.php" style="text-decoration: none;"><button type="button" class="list-group-item list-group-item-action">Teacher List</button></a>
  <a href="teacheredit.php" style="text-decoration:none;"><button type="button" class="list-group-item list-group-item-action">Edit & Delete</button></a>
  ...
  <hr style="color:white;">
  <a href="teacher1.php"><button class="btn btn-success" aria-current="true" style="width:370px">Close</button></a>
</div>
</div>
