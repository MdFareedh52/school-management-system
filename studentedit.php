...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary col-md-6" style="width:1500px;position: relative;height: 80px;width: 1520px;">
...
if (isset($_POST['button'])) {
  ...
  $select="INSERT INTO student_insert(Id,Name,Age,Class,Email,DateofBirth,Gender,FatherName,MotherName,Address,City,State,Zip,Contact) VALUES(0,'$Name','$Age','$Class','$Email','$Date_of_Birth','$Gender','$fathername','$Mothername','$Address','$City','$State','$Zip','$Contact')";
...
if (mysqli_query($con,$select))
 ...
 $select_query = "SELECT * FROM student_insert ";
...
?> 
 <div class="table-responsive" >
     <table class="table table-striped table-hover"  id="user_data">
      <tr>
       <th>Id</th>
       <th>Name</th>
       <th>Age</th>
      ...
      <?php
        while($row = mysqli_fetch_assoc($selectt_result)) {
         ...
         echo  "<tr>
          ...
          <td><a href='studentedit1.php?id=$fun'><button type='button' class='btn btn-primary'>Edit</button></a></td>

          <td><a href='studentdel.php?id=$fun;'><button type='button' class='btn btn-success' >Delete</button></a></td>
       </td>";    
        }
      ?>
      <div>
        <a href="studentlist.php"><button class="btn btn-secondary" style="margin-left:1290px;margin-top: 10px;margin-bottom: 10px;"><img src="img/previous.png" style="height:25px;width: 25px;margin-right: 5px;">Back</button></a>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <hr style="color:white;">
  <a href="studentedit.php"><button class="btn btn-success" aria-current="true" style="width:370px">Close</button></a>
</div>
</div>
