  ...
  <nav>
    <a href="home.php" aria-label="Teacher" class="logo" style="margin-right: 30px;">
      <svg width="10" height="10">
       <img src="img/test.png" href="#logo" style="margin-left: 10px;"><h3 style="margin-left: 30px;">Principal</h3>
      </svg>
    </a>
...
<section class="page-content" style="display: inline-blocks; margin-left: 30px;width: 1250px;">
  ...
  <h1 style="font-weight: 900;">Show Approved <span style="font-weight: 900;color: #0099ff;">Events!</span></h1>
<?php  
$user = 'root';
$password = ''; 
$database = 'school1'; 
...
<table class="table table-hover table-striped">
         ...
         <a href="event.php" type="submit" class="btn btn-success" style="margin-left: 600px;height: 40px;width: 70px;">Back</a>
        <?php }else {?>
          <!-- FORE USERS -->
...
<!--NavBar-->
<nav class="navbar navbar-expand-lg navbar-dark col-md-6" style="width:1500px;background-color: #242E42;position: relative;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <a class="navbar-brand" href="home.php" style="font-size:30px; margin-left: 270px; font-weight: 900; text-shadow: 3px 3px black;"><img src="img/notepad.png" style="height:40px;width: 40px;margin-bottom: 7px;"> Report</a>
...
<span id='ct7' style="color: orange; font-size: 23px; font-weight: 800; text-shadow:2px 2px red ;"></span>     
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="home.php" style="margin-top:5px;font-size: 20px;margin-left:380px;color: white;"><img src="img/home.png" style="height:25px;width: 25px;display: inline; margin-bottom:5px;margin-right: 5px; color: white;">Dashboard</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="attendence.php" style="margin-top: 5px; font-size: 20px;"><img src="img/calendar-interface-symbol-tool.png" style="display:inline; height: 25px; width: 25px;margin-right: 5px;">calendar</a>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/user2.png" style="height: 40px;width: 40px;">
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="background-color:#242E42;width: 10px;">
          <a class="dropdown-item" href="home.php" style="onmouseover="this.style.background='white'; 
          onmouseout="this.style.background='white';background-color:#242E42;color: white;">
            <img src="img/easy-installation.png" style="height:25px;width: 25px;margin-right: 7px;">
           <span style="color: white;"> Teacher<span>
          </a>
          <a class="dropdown-item" href="logout.php" class="btn btn-secondary" style="background-color:#242E42;color: white;"><img src="img/enter.png" style="height: 25px; width: 25px;margin-right: 10px;">Logout</button></a>
        </div>
      </li>
    </ul>
  </div>
...
<table class="table table-hover table-striped">
         ...
         <a href="eventapproval.php" type="submit" class="btn btn-success" style="margin-left: 600px;height: 40px;width: 70px;">Back</a>
        </div>
      </div>
        <?php } ?>
      </div>
