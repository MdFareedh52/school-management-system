		...
		<div class="card col-md-12 bg-dark">
			<div class="card-header bg-dark col-md-12">
				<h2>
					...
					<a class="btn btn-warning float-right" style="margin-right:5px;" href="../attendence.php">Back</a>
				</h2>
			</div>
			...
			<div class="card-body" style="background-color:#212529;">
				...
				<form action="" method="post">
					<table class="table table-striped table-dark table-bordered table-hover col-md-12">
						<tr>
