...
<section class="page-content bg-dark">
  <section class="search-and-user bg-dark">
			...
			<div class="card-body">
				<form action="" method="post">
					<table class="table table-dark table-hover">
						<tr>
							<th width="30%" style="font-weight:900; color: #FFD700;">S/No</th>

							<th width="30%" style="font-weight:900; color: #FFD700;">Attendance Date</th>
               <th width="30%" style="font-weight:900;color: #FFD700;">Class</th>
...
?>
              ...
              <td>class1</td>
							<td>
							<a class="btn btn-primary" href="view.php?dt=<?php echo $value['att_time']; ?>">View</a>
							</td>
						</tr>
<?php } } ?>
					</table>
				</form>
				<a href="../Attendancereport.php" class="btn btn-success" style="margin-left: 440px; height: 40px;" >Back</a>
			</div>
		</div>
	</div>