...
<h1 style="margin-left: 10px;font-weight: 900;">Edit &<span style="color:blue"> Delete</span></h1>
 <?php
 ...
 <div class="table-responsive">
     <table class="table table-striped table-hover"  id="user_data">
      ...
      <?php
        while($row = mysqli_fetch_assoc($selectt_result)) {
         ...
         echo  "<tr>
          ...
          <td><a href='teacheredit1.php?id=$fun'><button type='button' class='btn btn-primary'>Edit</button></a></td>

          <td><a href='teacherdelete.php?id=$fun;'><button type='button' class='btn btn-success' >Delete</button></a></td>
      ...
      ?>
       ...
       <a href="teacherlist.php"><button class="btn btn-secondary" style="margin-left:1300px;margin-top: 10px;margin-bottom: 10px;"><img src="img/previous.png" style="height:25px;width: 25px;margin-right: 5px;">Back</button></a>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <a href="teacher1.php" style="text-decoration: none;"><button type="button" class="list-group-item list-group-item-action">Student List</button></a>
  ...
  <hr style="color:white;">
  <a href="teacheredit.php"><button class="btn btn-success" aria-current="true" style="width:370px">Close</button></a>
</div>
</div>
