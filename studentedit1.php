...
<body>
  ...
  include('db_conn.php');
  $id=$_GET['id'];
  $query=mysqli_query($conn,"select * from `student_insert` WHERE id='$id' ");
 ...
 if (isset($_POST['update'])) {
  ...
  $sql="UPDATE `student_insert` SET Name='$Name',Age='$Age',Class='$Class',Email='$Email',DateofBirth='$Date_of_Birth',Gender='$Gender',Fathername='$fathername',MotherName='$Mothername',Address='$Address',State='$State',Zip='$Zip',Contact='$Contact' WHERE id='$id'";
...
<form action="" method="post" class="row g-3" id="user_form" style="padding-bottom:20px;margin-left: 10px;">
...
<div class="col-5">
  ...
  <div class="col-md-3">
    ...
    <select id="inputState" class="form-select" name="state" value="<?php echo $row['State']; ?>">
  ...
  <div class="col-md-3">
    ...
    <input type="text" class="form-control" id="inputZip" name="zip" value="<?php echo $row['Zip']; ?>">
    <div> 
    <input type="submit" class="btn btn-success" id="btn-add" name="update" value="update" style="margin-top:10px;">
    <a href="studentlist.php"><button type="button" class="btn btn-danger" style="margin-top:10px;">Back</button></a>
  </div>
</form>
</body>
</html>
