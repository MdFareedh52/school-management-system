...
<head>
  ...
  <link rel="shortcut icon" href="img/test1.png" style="height:20px;">
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="studentlist.php">
          ...
          <span style="margin-left: 10px;">Students List<img src="img/icons/right-arrow.png" style="height:25px;margin-left: 30px;"></span>
        </a>
      </li>
      <li>
