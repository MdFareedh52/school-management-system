...
<head>
  <title>student</title>
  <link rel="shortcut icon" href="img/user.png" style="height:20px;">
  ...
  function validateForm() {
    ...
    var g = document.forms["Form"]["fname"].value;
    var h = document.forms["Form"]["mname"].value;
    var i = document.forms["Form"]["address"].value;
    var j = document.forms["Form"]["city"].value;
    var k = document.forms["Form"]["state"].value;
    var l = document.forms["Form"]["zip"].value;
    var m = document.forms["Form"]["contact"].value;
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary col-md-6" style="width:1500px;position: relative;height: 80px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <a class="navbar-brand" href="#home" style="font-size:30px; margin-left: 300px; font-weight: 900; color: white;text-shadow: 2px 2px black;">Student</a>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="student.php">
          ...
          <span style="margin-left: 10px;">Student<img src="img/icons/right-arrow.png" style="height:25px;margin-left: 50px;"></span>
        </a>
      </li>
      <li>
        <a href="teacher.php">
...
<div class="container bg-light" style="width: 1100px;margin-right: 130px;">
  <div class="card-body" style="background-color:#9C27B0;margin-bottom: 20px;">
    <div class="row-right">
    <h3 style="font-weight: 900;color: white;text-shadow: 2px 2px black;">Student Profile</h3>
    <h5 style="font-weight: 900;margin-left: 20px;"> <svg style="height: 35px;width: 35px;display: inline;margin-right: 7px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="users" class="svg-inline--fa fa-users fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="currentColor" d="M96 224c35.3 0 64-28.7 64-64s-28.7-64-64-64-64 28.7-64 64 28.7 64 64 64zm448 0c35.3 0 64-28.7 64-64s-28.7-64-64-64-64 28.7-64 64 28.7 64 64 64zm32 32h-64c-17.6 0-33.5 7.1-45.1 18.6 40.3 22.1 68.9 62 75.1 109.4h66c17.7 0 32-14.3 32-32v-32c0-35.3-28.7-64-64-64zm-256 0c61.9 0 112-50.1 112-112S381.9 32 320 32 208 82.1 208 144s50.1 112 112 112zm76.8 32h-8.3c-20.8 10-43.9 16-68.5 16s-47.6-6-68.5-16h-8.3C179.6 288 128 339.6 128 403.2V432c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48v-28.8c0-63.6-51.6-115.2-115.2-115.2zm-223.7-13.4C161.5 263.1 145.6 256 128 256H64c-35.3 0-64 28.7-64 64v32c0 17.7 14.3 32 32 32h65.9c6.3-47.4 34.9-87.3 75.2-109.4z"></path></svg> complete your profile<a href="studentlist.php"><button class="btn btn-warning" style="margin-left:650px">Show List</button></a></h5>
  </div>
  </div>
  <span  class="border-end-0"><form class="row g-3" method="post" action="student.php" onsubmit="return validateForm()" name="Form" style="width: 1000px;"> 
  <div class="col-md-6">
    <label for="name" class="form-label" style="font-weight: bold;font-size: px;">Name</label>
    <input type="text" class="form-control" id="name" name="name">
  </div>
  <div class="col-md-3">
    <label for="age" class="form-label" style="font-weight: bold;font-size: px;">Age</label>
    <input type="age" class="form-control" id="age" name="age">
  </div>
  <div class="col-md-3">
    <label for="class" class="form-label" style="font-weight: bold;font-size: px;">Class</label>
    <input type="text" class="form-control" id="class" placeholder="" name="class">
  </div>
  <div class="col-md-6">
  	<label for="email" class="form-label" style="font-weight: bold;font-size: px;">Email</label>
  	<input type="email" class="form-control" name="email" id="email">
  </div>
  <div class="col-md-6">
  <label for="example-date-input" class="col-2 col-form-label" style="font-weight: bold;font-size: px;">DOB</label>
  <div class="col-6">
    <input class="form-control" type="date" value="" id="example-date-input" name="dateofbirth">
  </div>
  </div>
  <div class="col-md-3">
  	<label for="gender" class="form-label" style="font-weight: bold;font-size: ;">Gender</label>
  ...
  <div class="col-md-4">
    <label for="father" class="form-label" style="font-weight: bold;font-size: ;">Father Name</label>
    <input type="text" class="form-control" id="fname" placeholder="" name="fname">
  </div>
  <div class="col-md-4">
    <label for="mother" class="form-label" style="font-weight: bold;font-size: ;">Mother Name</label>
    <input type="text" class="form-control" id="mname" placeholder="" name="mname">
  </div>
  <div class="col-8">
    <label for="inputAddress2" class="form-label" style="font-weight: bold;font-size: ;">Address</label>
    <input type="text" class="form-control" id="address" placeholder="" name="address">
  </div>
  <div class="col-md-4">
    <label for="inputCity" class="form-label" style="font-weight: bold;font-size: ;">City</label>
    <input type="text" class="form-control" id="city" name="city">
  </div>
  <div class="col-md-4">
    <label for="inputState" class="form-label" style="font-weight: bold;font-size: ;">State</label>
  ...
  <div class="col-md-3">
    <label for="inputZip" class="form-label" style="font-weight: bold;font-size: ;">Zip</label>
    <input type="text" class="form-control" id="inputZip" name="zip">
  </div>
  <div class="col-md-3">
  	<label for="contact" class="form-label" style="font-weight: bold;font-size: ;">Contact</label>
  	<input type="number"  class ="form-control" name="contact" id="contact">
  </div>
  <div class="col-12">
    <button type="submit" class="btn btn-success" name="insert" id="insert" style="width: 1080px;margin-bottom: 10px;">Insert</button>
  </div>
</form>
</span>
</div>
