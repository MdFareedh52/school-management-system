...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `student_insert` WHERE CONCAT(`id`, `Name`, `Class`, `DateofBirth`) LIKE '%".$valueToSearch."%'";
...
<span id='ct7' style="color: black; font-size: 23px; font-weight: 900;padding-bottom: 40px;"></span></a>
      ...
      <li class="nav-item1-dropdown">
        ...
        <form action="student1.php" method="post" style="margin-top:50px; margin-left: 10px;">
            ...
            <a href="student1.php"><button class="btn btn-warning"style="margin-bottom: 10px;margin-left: 1000px;">Show Full</button></a>
   ...
   <a href="studentlist.php"><button class="btn btn-success" style="margin-left:1280px;"><img src="img/previous.png" style="height:25px;width: 25px; margin-right: 5px;">Back</button></a>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <hr style="color:white;">
  <button type="button" class=" text-reset btn btn-success" data-bs-dismiss="offcanvas" aria-label="Close" style="color:white;">close</button>
</div>
</div>
