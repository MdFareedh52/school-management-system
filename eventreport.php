...
<head>
  <title>Event Report</title>
   <link rel="shortcut icon" href="img/party.png" style="height:20px;">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary col-md-6" style="width:1500px;position: relative;height: 80px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <a class="navbar-brand" href="#home" style="font-size:30px; margin-left: 300px; font-weight: 900; color: white;text-shadow: 2px 2px black;">Event-Report</a>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="eventreport.php">
          ...
          <span style="margin-left: 10px;">Event Report<img src="img/icons/right-arrow.png" style="height:25px;margin-left: 30px;"></span>
        </a>
      </li>
      <li class="menu-heading">
        <h3>List</h3>
...
<div class="container bg-light" style="width: 1100px;margin-right: 130px;">
  <div class="card-body" style="background-color:#9C27B0;margin-bottom: 20px;">
    <div class="row-right">
    <h3 style="font-weight: 900;color: white;text-shadow: 2px 2px black;">Event-Report</h3>
    <h5 style="font-weight: 900;margin-left: 20px;"><svg style="height: 30px;width: 30px;display: inline;margin-right: 7px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="clipboard-list" class="svg-inline--fa fa-clipboard-list fa-w-12" role="img" viewBox="0 0 384 512"><path fill="currentColor" d="M336 64h-80c0-35.3-28.7-64-64-64s-64 28.7-64 64H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM96 424c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm96-192c13.3 0 24 10.7 24 24s-10.7 24-24 24-24-10.7-24-24 10.7-24 24-24zm128 368c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16z"></path></svg>Complete the Event <!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="margin-left:650px">
  Show Report
</button>
<!-- Modal -->
  ...
  <div class="modal-dialog  modal-xl">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="staticBackdropLabel">Event Report</h5>
...
$sql = "SELECT * FROM eventreport ORDER BY id asc ";
...
<table class="table  table-striped table-hover">
            ...
            <tr>
                ...
                <td><?php echo $rows['Discription'];?></td>
                 <td><?php echo $rows['ChiefGuest'];?></td>
                  <td><?php echo $rows['Place'];?></td>
                   <td><img src="img/icons/check.png" style="height: 30px;"></td>
            </tr>
            <?php
                }
             ?>
...
<form action="#" method="POST" class="row g-3">
      ...
      <input type="text" name="eventtitle" id="eventtitle" class="form-control" placeholder="Event Titile">
    </div>
    <section>
      <div class="col-md-10">
    ...
    <input type="date" class="form-control" id="inputBirth" name="date">
      ...
      <div class="col-md-10">
        <label for="inputAddress1" class="form-label">Publish Date</label>
    <input type="date" class="form-control" id="inputBirth" name="publish">
      </div>
    </section>
       <div class="col-md-5">
     ...
     <div class="col-md-5">
      ...
      <div class="col-md-5">
      <label class="form-label">Principal Approved</label>
      <input type="text" name="approval" id="approval" class="form-control">
      </div>
      <div class="col-md-3">
      <input type="submit" name="submit" class="btn btn-success" style="margin-bottom: 20px;width: 1070px;">
    </div>
    </form>
  ...
  <nav>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="eventreport.php">
          <img src="img/icons/verify.png" style="height:30px;">
          <span style="margin-left: 10px;">Event Report<img src="img/icons/right-arrow.png" style="height:25px;margin-left: 0px;"></span>
        </a>
      </li>
      <li class="menu-heading">
        <h3></h3>
